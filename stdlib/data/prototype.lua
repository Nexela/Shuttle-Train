...
function Prototype.duplicate_prototype(data_type, orig_name, new_name, mining_result)
    ...
    if data.raw[data_type][orig_name] then
        ...
        if proto.place_result then
             proto.place_result = new_name end
        if proto.result then proto.result = new_name end
        return(proto)
    else
